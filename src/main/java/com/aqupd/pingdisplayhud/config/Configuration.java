...
public class Configuration {
  ...
  public static float getGuiXPercentage() {
    return guiXPercentage;
  }
  public static float getGuiYPercentage() {
    return guiYPercentage;
  }
  ...
  public static void setBgOpacity(int bgOpacity) {
    Configuration.bgOpacity = bgOpacity;
    saveOptions();
  }
  public static void setBlueColor(int blueColor) {
    Configuration.blueColor = blueColor;
    saveOptions();
  }
  public static void setGreenColor(int greenColor) {
    Configuration.greenColor = greenColor;
    saveOptions();
  }
  public static void setRedColor(int redColor) {
    Configuration.redColor = redColor;
    saveOptions();
  }
  public static void setGuiXPercentage(float guiXPercentage) {
    Configuration.guiXPercentage = guiXPercentage;
    saveOptions();
  }
  public static void setGuiYPercentage(float guiYPercentage) {
    Configuration.guiYPercentage = guiYPercentage;
    saveOptions();
  }
  ...
  public static void setxAxis(boolean xAxis) {
    Configuration.xAxis = xAxis;
    saveOptions();
  }
  public static void setyAxis(boolean yAxis) {
  ...
  public static void loadOptions() {
    try {
      ...
      while ((s = bufferedreader.readLine()) != null) {
        ...
        if (astring[0].equals("prefix")) prefix = strstring[1];
        if (astring[0].equals("suffix")) suffix = strstring[1];
